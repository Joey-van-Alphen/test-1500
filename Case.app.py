...
fig.append_trace(go.Scatter(
    x=samengestelde_tabel_streamlit['vulgraad_pax'],
    y=samengestelde_tabel_streamlit['CO2 uitstoot (mln kg)'],
    mode="markers"
), row=1, col=1)

fig.append_trace(go.Scatter(
    x=samengestelde_tabel_streamlit['vulgraad_vracht'],
    y=samengestelde_tabel_streamlit['CO2 uitstoot (mln kg)'],
    mode="markers"
), row=2, col=1)

fig.append_trace(go.Scatter(
    x=samengestelde_tabel_streamlit['vulgraad_post'],
    y=samengestelde_tabel_streamlit['CO2 uitstoot (mln kg)'],
    mode="markers"
), row=3, col=1)

fig.update_xaxes(title_text="Vulgraad passagiers", row=1, col=1)
fig.update_xaxes(title_text="Vulgraad vracht", row=2, col=1)
fig.update_xaxes(title_text="Vulgraad post", row=3, col=1)

fig.update_yaxes(title_text="CO2 uitstoot (mln kg)", row=1, col=1)
fig.update_yaxes(title_text="CO2 uitstoot (mln kg)", row=2, col=1)
fig.update_yaxes(title_text="CO2 uitstoot (mln kg)", row=3, col=1)

fig.update_layout(height=1000, width=1000, title_text="Verband tussen CO2 uitstoot en de vulgraad")
